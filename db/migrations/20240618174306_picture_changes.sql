-- Modify "posts" table
ALTER TABLE "post_service"."posts" ADD COLUMN "picture_url" character varying(64) NOT NULL, ADD COLUMN "picture_width" integer NOT NULL, ADD COLUMN "picture_height" integer NOT NULL;
-- Modify "users" table
