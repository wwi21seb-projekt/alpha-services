...
func (n *NotificationHandler) GetPublicKey(c *gin.Context) {
	...
	if err != nil {
		...
		n.logger.Error("Error in upstream call n.pushSubscriptionService.GetPublicKey", zap.Error(err))
...
func (n *NotificationHandler) CreatePushSubscription(c *gin.Context) {
	...
	if err != nil {
		...
		n.logger.Error("Error in upstream call n.pushSubscriptionService.CreatePushSubscription", zap.Error(err))
		c.JSON(returnErr.HttpStatus, returnErr)
		return
	}
...
func (n *NotificationHandler) GetNotifications(c *gin.Context) {
	...
	if err != nil {
		...
		n.logger.Error("Error in upstream call n.notificationService.GetNotification", zap.Error(err))
		c.JSON(returnErr.HttpStatus, returnErr)
		return
	}
...
func (n *NotificationHandler) DeleteNotification(c *gin.Context) {
	...
	if err != nil {
		...
		n.logger.Error("Error in upstream call n.notificationService.DeleteNotification", zap.Error(err))
		c.JSON(returnErr.HttpStatus, returnErr)
		return
	}
